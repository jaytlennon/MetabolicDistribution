...
Overview: Simulation model for assessing how metabolic inequality affects 
...
# Second, Michaelis-Menten dynamics with different half-saturation constants (Km)
...
```{r}
# Respiration ratio as function of skew (sigma)
